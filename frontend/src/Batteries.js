    ...
    <div>
        ...
        <div class="container py-5">
            ...
            <ul class="nav nav-pills nav-fill mb-4" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="pills-batteries-tab" data-toggle="pill" href="#pills-batteries" role="tab" aria-controls="pills-batteries" aria-selected="false">Batteries</a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-batteries" role="tabpanel" aria-labelledby="pills-batteries-tab">
                    <div className="row text-center text-lg-left">
