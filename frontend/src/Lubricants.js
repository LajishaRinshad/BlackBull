    ...
    <div>
        ...
        <div class="container py-5">
            ...
            <ul class="nav nav-pills nav-fill mb-4" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="pills-lubricants-tab" data-toggle="pill" href="#pills-lubricants" role="tab" aria-controls="pills-lubricants" aria-selected="false">Lubricants</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="pills-tubes-tab" data-toggle="pill" href="#pills-tubes" role="tab" aria-controls="pills-tubes" aria-selected="false">Tubes</a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-lubricants" role="tabpanel" aria-labelledby="pills-lubricants-tab">
                    <div className="row text-center text-lg-left">
                        <div className="col-lg-2 col-md-3 col-4">
                ...
                <div class="tab-pane fade" id="pills-tubes" role="tabpanel" aria-labelledby="pills-tubes-tab">
                    <div className="row text-center text-lg-left">
